	...
	<div class="container">
		<div class="row">
			<div class="col" style="border:solid 1px">
				...
				<button type="button" class="btn btn-primary" id="round-btn">Free Consultation</button>
				<button type="button" class="btn btn-dark" id="round-btn">Browse Tutor</button>
			</div>
			<div class="col" style="border:solid 1px">
			Illustration
			</div>
		...
		<div class="row">
			...
			<div class="col" style="border:solid 1px">
			<h3>"I can't believe how fast my scores improved!"</h1>
			<p class="text-muted">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
			</p>
			</div>
		...
		<div class="row">
			<div class="col blue-col">
				...
				<div class="row">
					...
					<div class="col-3">
					<button type="button" class="btn btn-dark" id="round-btn">Select Date Time</button>
					</div>
				</div>
			</div>
		</div>
